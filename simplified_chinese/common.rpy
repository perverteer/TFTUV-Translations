...
translate simplified_chinese strings:
    ...
    new "复制解析错误文件（errors.txt）到剪贴板，作为 Discord 的 Markdown。"# TODO: Translation updated at 2024-12-10 09:41

translate simplified_chinese strings:

    # renpy/common/00accessibility.rpy:121
    old "Accessibility Menu. Use up and down arrows to navigate, and enter to activate buttons and bars."
    new "无障碍菜单。使用上下箭头导航，回车键激活按钮和栏。"
    ...
    new "单击可切换属性，右击可切换负属性。"

    # renpy/common/00director.rpy:1776
    old "Click to set transform, right click to add to transform list."
    new "单击设置变换，右击添加到变换列表。"

    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "自定义 director.transforms，添加更多变换。"
    ...
    new "自定义 director.transitions，添加更多转场效果。"
    ...
    new "此保存文件是在不同设备上创建的。恶意创建的保存文件可能会损害您的计算机。你相信这个保存文件的创建者和所有可能更改文件的人吗？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "您信任创建保存的设备吗？只有当您是该设备的唯一用户时，才应选择 “是”。"
    ...
    new "这将联系 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。"
    ...
    new "此同步将在一小时后失效。Ren'Py同步由{a=https://www.renpy.org/sponsors.html}Ren'Py的赞助商{/a}支持。"
    ...
    new "{a=edit:1:log.txt}log.txt{/a}文件可能包含帮助您确定计算机故障原因的信息。"
