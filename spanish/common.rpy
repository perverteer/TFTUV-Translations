...
translate spanish strings:
    ...
    new "Las opciones de este menú están pensadas para mejorar la accesibilidad. Es posible que no funcionen con todos los juegos, y algunas combinaciones de opciones pueden hacer que el juego no sea jugable. Esto no es un problema del juego o del motor. Para obtener los mejores resultados al cambiar los tipos de letra, intenta mantener el tamaño del texto tal y como era originalmente."
    ...
    new "¿Estás seguro de que quieres borrar este archivo?"
    ...
    new "¿Está seguro de que quiere empezar a saltar?"
    ...
    new "¿Estás seguro de que quieres saltar el diálogo no visto a la siguiente opción?"
    ...
    new "Este programa contiene software libre bajo una serie de licencias, incluyendo la Licencia MIT y la Licencia Pública General Menor de GNU. Una lista completa de software, incluyendo enlaces al código fuente completo, se puede encontrar {a=https://www.renpy.org/l/license}aqui{/a}."
    ...
    new "saltar lo no visto [texto]"

    # renpy/common/00preferences.rpy:318
    old "skip unseen text"
    new "saltar el texto no visto"
    ...
    old "self voicing"
    new "autovocalización"

    # renpy/common/00preferences.rpy:402
    old "self voicing volume drop"
    new "autovocalización bajada de volumen"
    ...
    old "font transform"
    new "transformación de la fuente"

    # renpy/common/00preferences.rpy:462
    old "font size"
    new "tamaño de la fuente"
    ...
    new "La voz propia diría \"[renpy.display.tts.last]\". Press 'alt+shift+V' para desactivar."

    # renpy/common/00preferences.rpy:603
    old "Self-voicing enabled. Press 'v' to disable."
    new "Autofacturación activada. Pulse 'v' para desactivarla."
    ...
    new "\n{color=#cfc}✔ imagen prevista (good){/color}\n{color=#fcc}✘ imagen imprevista (bad){/color}\n{color=#fff}Arrastra para moverte.{/color}"
    ...
    new "Mientras se desempaquetaba {}, tipo desconocido {}."
    ...
    new "Las actualizaciones han sido instaladas. El programa se reinicia."
    ...
    new "El {a=edit:1:log.txt}log.txt{/a} puede contener información que le ayude a determinar qué es lo que falla en su ordenador."

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "Puede encontrar más detalles sobre cómo solucionarlo en la {a=[url]}documentación{/a}."
...
# TODO: Translation updated at 2023-07-10 22:12
...
# TODO: Translation updated at 2023-07-10 22:23
